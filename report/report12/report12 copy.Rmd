...
```{r}
get.swap.ratio(adapt_PT_new_rho)
```
...
```{r}
adapt_PT_new_rho[[1]]$H_l[,11951:12000]
```
...
```{r}
load("./report/report12/adapt_PT_new_rho4.RData")
```
...
```{r}
adapt_PT_new_rho4[[1]]$H_l[,7951:8000]
```
...
```{r}
load("./report/report12/adapt_PT_new_rho6.RData")
```
...
```{r}
adapt_PT_new_rho6[[1]]$H_l[,7951:8000]
```
...
```{r}
load("./report/report12/adapt_PT_new_rho3.RData")
```
...
```{r}
adapt_PT_new_rho3[[1]]$H_l[,7951:8000]
```
...
```{r}
load("./report/report12/adapt_PT_new_rho5.RData")
```
...
```{r}
adapt_PT_new_rho5[[1]]$H_l[,7951:8000]
```
...
```{r}
load("./report/report12/adapt_PT_new_rho2.RData")
```
...
```{r}
adapt_PT_new_rho2[[1]]$H_l[,11951:12000]
```
...
```{r}
load("./report/report12/adapt_prec_mat.RData")
```
