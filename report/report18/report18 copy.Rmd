...
```{r r1, cache=TRUE}
load("./report/report18/noa_multi_poly_trim05.RData")
...
```{r r2, cache=TRUE}
load("./report/report18/noa_multi_poly_trim1.RData")
noa_multi_poly_trim1_coda <- multi_chain_coda_noa(noa_multi_poly_trim1, burn = 0, N_para, p, order = 3)
...
```{r r3, cache=TRUE}
load("./report/report18/noa_multi_poly_trim1_o2.RData")
...
```{r r4, cache=TRUE}
load("./report/report18/multi_adapt_poly_trim05_o2.RData")
...
```{r rl1, cache=TRUE}
load("./report/report18/multi_adapt_poly_trim05_o3.RData")
...
```{r rl2, cache=TRUE}
load("./report/report18/multi_adapt_poly_trim05_o2_jbw.RData")
...
```{r rl3, cache=TRUE}
load("./report/report18/multi_adapt_poly_trim05_o3_jbw.RData")
