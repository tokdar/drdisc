...
realdata_notrim_order4 <- foreach(i = 1:N_para,
...
names = paste0("./real_data_result/Feb_23/realdata_notrim_order4_40k_seed_", seed, ".RData")
save(realdata_notrim_order4, file = names)


realdata_notrim_order4_coda <- multi_chain_coda(realdata_notrim_order4,
                                                burn = 15000, N_para, p, order = order)
plot(realdata_notrim_order4_coda)
gelman.diag(realdata_notrim_order4_coda)
summary(realdata_notrim_order4_coda)

realdata_CI_nto4 <- get.result.CI(realdata_notrim_order4, N_para, p)

## trimming = 0.9

data_trim09 <- get.trim.data(0.9)

realdata_trim09_order4 <- foreach(i = 1:N_para,
                                  .packages='BayesLogit') %dorng% 
...
names = paste0("./real_data_result/Feb_23/realdata_trim09_order4_40k_seed_", seed, ".RData")
save(realdata_trim09_order4, file = names)

realdata_trim09_order4_coda <- multi_chain_coda(realdata_trim09_order4,
                                                burn = 15000, N_para, p, order = order)
plot(realdata_trim09_order4_coda)
gelman.diag(realdata_trim09_order4_coda)
summary(realdata_trim09_order4_coda)
...
realdata_trim08_order4 <- foreach(i = 1:N_para,
                                  .packages='BayesLogit') %dorng% 
...
names = paste0("./real_data_result/Feb_23/realdata_trim08_order4_40k_seed_", seed, ".RData")
save(realdata_trim08_order4, file = names)

realdata_trim08_order4_coda <- multi_chain_coda(realdata_trim08_order4,
                                                burn = 15000, N_para, p, order = order)
plot(realdata_trim08_order4_coda)
gelman.diag(realdata_trim08_order4_coda)
summary(realdata_trim08_order4_coda)
...
realdata_trim07_order4 <- foreach(i = 1:N_para,
                                  .packages='BayesLogit') %dorng% 
...
names = paste0("./real_data_result/Feb_23/realdata_trim07_order4_40k_seed_", seed, ".RData")
save(realdata_trim07_order4, file = names)

realdata_trim07_order4_coda <- multi_chain_coda(realdata_trim07_order4,
                                                burn = 15000, N_para, p, order = order)
plot(realdata_trim07_order4_coda)
gelman.diag(realdata_trim07_order4_coda)
summary(realdata_trim07_order4_coda)
...
realdata_trim06_order4 <- foreach(i = 1:N_para,
                                  .packages='BayesLogit') %dorng% 
...
names = paste0("./real_data_result/Feb_23/realdata_trim06_order4_40k_seed_", seed, ".RData")
save(realdata_trim06_order4, file = names)

realdata_trim06_order4_coda <- multi_chain_coda(realdata_trim06_order4,
                                                burn = 15000, N_para, p, order = order)
plot(realdata_trim06_order4_coda)
gelman.diag(realdata_trim06_order4_coda)
summary(realdata_trim06_order4_coda)
